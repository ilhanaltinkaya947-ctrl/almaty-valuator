      ...
      <div style={{ marginBottom: 16 }}>
        ...
        <div style={{
          ...
          {[
            ...
            { label: "В работе", value: leads.filter((l) => l.status === "in_progress" || l.status === "contacted").length, color: "#4A8FD4" },
            { label: "Закрыто", value: leads.filter((l) => l.status === "closed_won").length, color: "#25D366" },
          ].map((s) => (
              ...
              <>
                <button
                  ...
                  style={{
                    ...
                    color: "#25D366", fontSize: 12, fontWeight: 600, border: "1px solid #25D366",
                    cursor: "pointer",
                  }}
                >
                  Закрыть ✓
