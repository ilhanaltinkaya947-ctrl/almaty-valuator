        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-[13px] text-[#5A6478] leading-relaxed">
              Срочный выкуп недвижимости в Алматы. Любое состояние, оплата
              сразу.
            </p>
          </div>
          ...
          {/* Navigation */}
          <div>
            <div className="text-[13px] text-[#5A6478] mb-4 uppercase tracking-wider font-medium">
              Навигация
            </div>
            <nav className="flex flex-col gap-2.5">
              {NAV_LINKS.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="text-[13px] text-[#4A5168] hover:text-white transition-colors duration-200"
                >
                  {link.label}
                </a>
              ))}
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5 text-[13px] text-[#4A5168]">
              <a
              ...
              <span>г. Алматы, Мамыр 4 / дом 119</span>
