    ...
    >
      ...
      <div className="mx-auto max-w-[1120px] px-4 sm:px-6 py-10 sm:py-14">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
          ...
          {/* Navigation */}
          <div>
            <div className="text-[13px] text-[#9CA3AF] mb-4 uppercase tracking-[0.2em] font-medium">
              Навигация
            </div>
            <nav className="grid grid-cols-2 gap-x-6 gap-y-2">
              {NAV_LINKS.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="text-sm text-[#6B7280] hover:text-[#3A8D7B] transition-colors duration-200"
                >
                  {link.label}
                </a>
              ))}
        ...
        <div className="mt-10 pt-6 border-t border-[rgba(0,0,0,0.04)] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 text-sm text-[#25D366] hover:text-[#25D366]/80 transition-colors duration-200"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 text-sm text-[#6B7280] hover:text-[#1A2332] transition-colors duration-200"
            >
