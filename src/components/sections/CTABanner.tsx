    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background: "linear-gradient(90deg, transparent 0%, #3A8D7B 30%, #66BB6A 50%, #3A8D7B 70%, transparent 100%)",
        ...
        <div
          ...
          style={{
            background: "radial-gradient(ellipse, rgba(58,141,123,0.1) 0%, transparent 60%)",
            filter: "blur(80px)",
          }}
        />
        ...
        <div className="relative mx-auto max-w-[1000px] px-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-1">
                {[
                  ...
                  >
                    <span className="text-[#66BB6A]">{t.icon}</span>
                    {t.text}
                  </span>
                ))}
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 shrink-0">
              <a
                href="#calculator"
                className="gold-btn group inline-flex items-center justify-center gap-2 rounded-full px-6 sm:px-8 py-3.5 text-[14px] sm:text-[15px] font-semibold text-white transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(58,141,123,0.4)]"
                style={{
                  background: "linear-gradient(135deg, #66BB6A, #26A69A)",
                  boxShadow: "0 8px 32px rgba(58,141,123,0.3)",
                }}
              >
                Рассчитать
