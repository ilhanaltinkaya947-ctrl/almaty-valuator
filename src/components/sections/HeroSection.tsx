  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 60% at 20% 80%, rgba(200,164,78,0.05) 0%, transparent 50%), " +
      ...
      {particles.map((p, i) => (
        <div
          ...
          style={{
            ...
            backgroundColor: p.isGold ? "rgba(200,164,78,0.5)" : "rgba(255,255,255,0.12)",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-10 lg:gap-16 items-center">
            <div className="max-w-[640px]">
              ...
              >
                ...
                <span className="text-[12px] font-medium uppercase tracking-[0.15em]" style={{ color: "#C8A44E" }}>
              ...
              <div className="hero-animate-4 flex flex-wrap gap-1.5 sm:gap-2 mt-5">
                {[
                  ...
                  >
                    <span style={{ color: "#C8A44E" }}>{b.icon}</span>
                    {b.text}
                  </span>
                ))}
              </div>
            ...
            <div className="hidden lg:flex items-center justify-center pointer-events-none">
              <div className="relative w-[300px] h-[300px] xl:w-[360px] xl:h-[360px]">
                <div className="absolute inset-0 rounded-full" style={{ border: "1px solid rgba(200,164,78,0.12)", animation: "ringRotate 30s linear infinite" }}>
                  <div className="absolute -top-1 left-1/2 -translate-x-1/2 h-2 w-2 rounded-full" style={{ backgroundColor: "rgba(200,164,78,0.4)" }} />
                </div>
                <div className="absolute inset-[35px] rounded-full" style={{ border: "1px dashed rgba(200,164,78,0.08)", animation: "ringRotate 22s linear infinite reverse" }} />
                <div className="absolute inset-[70px] rounded-full" style={{ border: "1px solid rgba(200,164,78,0.06)", animation: "ringRotate 40s linear infinite" }}>
                  <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 h-1.5 w-1.5 rounded-full" style={{ backgroundColor: "rgba(200,164,78,0.3)" }} />
                </div>
                <div className="absolute inset-[105px] rounded-full" style={{ border: "1px solid rgba(200,164,78,0.04)", animation: "ringRotate 50s linear infinite reverse" }} />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 rounded-full gold-glow-pulse" style={{ background: "radial-gradient(circle, rgba(200,164,78,0.15) 0%, transparent 70%)" }} />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2.5 h-2.5 rounded-full" style={{ backgroundColor: "#C8A44E", boxShadow: "0 0 12px rgba(200,164,78,0.4)" }} />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="absolute bottom-16 left-1/2 -translate-x-1/2 scroll-indicator">
        <div className="flex flex-col items-center gap-2">
          <span className="text-[11px] uppercase tracking-[0.15em] text-[#3A4258]">Листайте</span>
          <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} style={{ color: "#3A4258" }}>
